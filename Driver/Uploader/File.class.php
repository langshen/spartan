...
class File extends SplFileObject
{
    ...
    public static function instance($filename) {
        return \Spt::getInstance(__CLASS__,$filename);
    }
    ...
    public function setSaveName($saveName)
    {
        ...
        $this->saveUrl = str_ireplace('\\','/',$saveName);
        return $this;
    }
     ...
     * @return bool
     */
    public function checkStar($arrRule){
        $strMime = explode('/',strtolower($this->getMime()))[0]??'';
        if (!$strMime){
            return false;
        }
     ...
     * @return string
     */
    public function buildSaveName($saveName=true)
    {
        if (true === $saveName) {
            // 自动生成文件名
